  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Foox - Your gateway to a world of freelance opportunities. Connect with companies offering jobs and launch your independent career today."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Foox - Your gateway to a world of freelance opportunities. Connect with companies offering jobs and launch your independent career today.`}
            </Text>
            <Box
